...
{ 
  ...
  MCONF_LOAD      ,        8, _BGR            , G_IBOX            ,   /* Object 7 FORMAT_BOX */
  ...
  MCONF_SAVE      ,       -1,       -1, G_BUTTON          ,   /* Object 18 MCONF_LOAD */
  SELECTABLE|EXIT|FLAGS9|FLAGS10, NORMAL, (LONG)"laden",
  0x0401, 0x000C, 0x0409, 0x0001,
         0,       -1,       -1, G_BUTTON          ,   /* Object 19 MCONF_SAVE */
  SELECTABLE|EXIT|LASTOB|FLAGS9|FLAGS10, NORMAL, (LONG)"speichern",
