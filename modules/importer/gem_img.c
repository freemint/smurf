...
#ifdef GERMAN
#define ERROR1 "[1][TrueColor GEM-Image werden noch nicht|unterstÅtzt.][ OK ]"
#define ERROR2 "[1][Ventura-Images werden noch nicht|unterstÅtzt. Bild bitte an uns einschicken!][ OK ]"
#else
#ifdef ENGLISH
#define ERROR1 "[1][TrueColor GEM-Image werden noch nicht|unterstÅtzt.][ OK ]"
