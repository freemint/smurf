...
{ "RLE",
  ...
  "Zu wenig Speicher um die Orientierung zu korrigieren.",
  "\0",
  "\0",
  IBM  , 0, TE_LEFT , 0x1180, 0, -1, 54, 1
};
...
{ 
  ...
  0x000A, 0x0008, 0x0008, 0x0001,
  
  /******** Tree 1 ALERT_STRINGS ****************************************************/
        -1, ORIENTCORR      , ORIENTCORR      , G_BOX             ,   /* Object 0  */
  NONE, SHADOWED, (LONG)0x00011100L,
  0x0000, 0x0000, 0x0437, 0x0009,
         0,       -1,       -1, G_TEXT            ,   /* Object 1 ORIENTCORR */
  LASTOB, NORMAL, (LONG)&rs_tedinfo[3],
  0x0001, 0x0800, 0x0035, 0x0001
};

OBJECT *rs_trindex[] =
{ &rs_object[0],   /* Tree  0 SGI_EXPORT       */
  &rs_object[10]    /* Tree  1 ALERT_STRINGS    */
};
